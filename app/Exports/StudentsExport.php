...
class StudentsExport implements FromCollection, WithHeadings
{
    public function collection()
    {
        ...
        // die;
        return (StudentDetail::with(['address', 'qualifications'])->get())->map(function ($student) {
            // dd($student->qualifications);
            return [
                'Full Name' => $student->firstname . ' ' . $student->middlename . ' ' . $student->lastname,
                'Email' => $student->email,
                'Mobile No' => $student->mobile_no,
                'Current Address' => $student->address ? $student->address->current_house_no . ', ' . $student->address->current_street . ', ' . $student->address->current_district . ', ' . $student->address->current_state . ' - ' . $student->address->current_pincode : 'Not Provided',
                'Permanent Address' => $student->address ? $student->address->permanent_house_no . ', ' . $student->address->permanent_street . ', ' . $student->address->permanent_district . ', ' . $student->address->permanent_state . ' - ' . $student->address->permanent_pincode : 'Not Provided',
